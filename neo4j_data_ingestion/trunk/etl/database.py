...
class Database(Logger):
	...
	def __init__(self):
		...
		conn_type = connection_dict.get("localConnection") #localConnection / devConnection / UATConnection
	...
	def get_neo4j_queries(self, neo4j_label, query_type, neo4j_entity):
		"""Fetch neo4j Queries from database."""
	...
	def fetch_all_mysql_data(self, date, data_type, query_type, neo4j_entity):
		"""."""
		
		query = self.get_mysql_queries(data_type, query_type, neo4j_entity)
		select_query = query.format(date)
