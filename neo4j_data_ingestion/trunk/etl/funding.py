...
class Funding(Database):
	...
	def initialize_variables(self):
		...
		self.neo4jQuery = self.get_neo4j_queries('Funding', 'merge', 'relation')
	...
	def get_data(self, data_set):
		...
		data = self.fetch_all_mysql_data(self.date, 'Funding', 'select', 'relation')
		return data
	...
	def run(cls, data_set='delta'):
		...
		funding = cls()
		data = funding.get_data(data_set)
